...
const loadSupplier = async () => {
  ...
  try {
    ...
    error.value = err.response?.data?.detail || 'Gagal memuat data supplier'
...
const handleSubmit = async () => {
  ...
  try {
    if (isEdit.value) {
      await suppliersApi.update(route.params.id, formData.value)
      await modal.showSuccess('Supplier berhasil diperbarui')
    } else {
      await suppliersApi.create(formData.value)
      await modal.showSuccess('Supplier berhasil dibuat')
    }
    router.push('/suppliers')
  } catch (err) {
    error.value = err.response?.data?.detail || 'Gagal menyimpan supplier'
  ...
  <div class="page-container">
    ...
    <form v-else @submit.prevent="handleSubmit" class="form-container">
      ...
      <div class="form-actions">
        <button type="button" class="btn-secondary" @click="router.push('/suppliers')">Batal</button>
